Pod::Spec.new do |spec|
    ...
    spec.source           = { :http => 'https://repository-engage.shopfully.tech/ShopFullyEngageSDK/2.3.3/ShopFullyEngageAdMobAdapter-2.3.3.zip' }
    ...
    spec.dependency 'ShopFullyEngageSDK', '2.3.3'
