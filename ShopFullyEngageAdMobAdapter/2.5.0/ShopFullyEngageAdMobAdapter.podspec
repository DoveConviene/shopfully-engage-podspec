Pod::Spec.new do |spec|
    ...
    spec.source           = { :http => 'https://repository-engage.shopfully.tech/ShopFullyEngageSDK/2.5.0/ShopFullyEngageAdMobAdapter-2.5.0.zip' }
    ...
    spec.dependency 'ShopFullyEngageSDK', '2.5.0'
