Pod::Spec.new do |spec|
    ...
    spec.source           = { :http => 'https://repository-engage.shopfully.tech/ShopFullyEngageSDK/2.7.0/ShopFullyEngageAdMobAdapter-2.7.0.zip' }
    ...
    spec.dependency 'ShopFullyEngageSDK', '2.7.0'
